...
num_list = [iteration for iteration in range(1, 6)]
...
"""[ result we need | condition (if-else ) | for for iteration r getting values from | condition if we want to filter 
the iteration values also"""
