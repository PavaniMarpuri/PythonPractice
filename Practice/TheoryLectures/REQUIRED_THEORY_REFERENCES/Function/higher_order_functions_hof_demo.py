...
result_copy, result = tee(result)  # tee creating another result and a copy of the result

squared_numbers = list(result_copy)
print(f"squared numbers: {squared_numbers}")  # Output: [1, 4, 9, 16, 25]
print(f"squared numbers result_copy : {list(result_copy)}")  # Output: [1, 4, 9, 16, 25]
