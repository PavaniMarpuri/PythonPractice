...
"""
=> File encoding is used to represent characters/letters/symbols ( called character set ) present in the file 
in the correct manner to compiler. 
=> That means process of converting characters (such as letters, punctuation, symbols, whitespace, and control characters) 
to numbers and, eventually, bits.
=> We can also say encoding is used to interpret file data correctly to compiler.
