...
# # since we are opening a file in append mode, write is not erasing existing data
...
# # x means explicitly create a file. it will create an empty file. and can do operations we need.
# # if we run this run second time we will get "FileExistsError"
...
# # we can use print to write to the text file .
# # print("data", file=file_name)
# # data will be written the given file
