...
with open(csv_path, "w", newline="") as csv_file:
    csv_writer = csv.writer(csv_file)  # Create a writer object (before actually writing to file)
    # csv_writer = writer(csv_file)  # we can use like this if we import writer from csv
...
with open(csv_path, "r") as csv_file:
    ...
    # csv_reader = reader(csv_file)  # we can use like this if we import reader from csv
...
with open(csv_path, "r") as csv_file:
    csv_reader = csv.reader(csv_file)
    print("Content of the CSV file 123 :")
